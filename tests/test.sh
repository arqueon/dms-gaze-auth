...
printf '%s\n' '[2/9] manifest syntax and invariants'
jq -e '
    .id == "gazeAuth"
    and .type == "widget"
...
printf '%s\n' '[5/9] unsupported Fedora release refusal'
...
printf '%s\n' '[7/9] unsupported suite refusal and status protocol'
...
printf '%s\n' '[9/9] local links, optional shellcheck, and optional qmllint'
